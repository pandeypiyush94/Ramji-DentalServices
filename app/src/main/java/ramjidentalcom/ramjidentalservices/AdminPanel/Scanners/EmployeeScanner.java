...
import ramjidentalcom.ramjidentalservices.AdminPanel.Registrations.EmployeeRegistration;
import ramjidentalcom.ramjidentalservices.HomePage;
import ramjidentalcom.ramjidentalservices.R;

public class EmployeeScanner extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        al = new AlertDialog.Builder(EmployeeScanner.this).create();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(EmployeeScanner.this, AdminDashboard.class);
    ...
    class FetchInBackground extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json_url = "http://ramjidental.com/RamjiApp/checkempid.php";
            String result = null;
            try {
    ...
    private void got(){
        Intent intent = new Intent(EmployeeScanner.this, EmployeeRegistration.class);
    ...
    public void handleResult(Result result) {
        ...
        if(ex.matches("(.*)emp(.*)")) {
            ...
            al.setMessage("This is not an Employee Card");
            al.setButton(DialogInterface.BUTTON_NEUTRAL, "CLOSE", new DialogInterface.OnClickListener() {
                @Override
                public void onClick(DialogInterface dialog, int which) {
                    dialog.dismiss();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                Intent intent;
                intent = new Intent(EmployeeScanner.this, HomePage.class);
