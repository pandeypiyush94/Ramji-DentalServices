...
import ramjidentalcom.ramjidentalservices.AdminPanel.GetImages;
...
public class UpdateClntCustImage extends AppCompatActivity implements  ConnectivityReceiver.ConnectivityReceiverListener{
    boolean isConnected;
    String id = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.update_clnt_cust_image);
        ...
        DisplayImageOptions defaultOptions = new DisplayImageOptions.Builder()
                ...
                .showImageOnLoading(R.drawable.gallery)
                .showImageOnFail(R.drawable.cicon)
                .cacheOnDisk(true)
                .build();
        ...
        lv = findViewById(R.id.clntpatimgupdtlistview);
        ...
        class UploadImage1 extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UpdateClntCustImage.this, "Uploading...", null,true,true);
            ...
            protected void onPostExecute(String s) {
                ...
                if(s.equals("success")|| s.equals("success2")){
                    ...
                    al.setButton(DialogInterface.BUTTON_NEGATIVE, "CANCEL", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent intent = new Intent(UpdateClntCustImage.this, AdminDashboard.class);
    ...
    class FetchInBackground extends AsyncTask<String, Void, List<GetImages>> {

        @Override
        protected List<GetImages> doInBackground(String... params) {
            String json_url = "";
            ...
            try {
                ...
                List<GetImages> getImages = new ArrayList<>();

                for (int i = 0; i < firstArray.length(); i++) {
                    JSONObject lastObject = firstArray.getJSONObject(i);
                    GetImages getImage = new GetImages();
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog=ProgressDialog.show(UpdateClntCustImage.this,"Downloading Images",null,true,true);


        }

        @Override
        protected void onPostExecute(List<GetImages> result) {
            super.onPostExecute(result);



           ImageAdapter adapter = new ImageAdapter(getApplicationContext(),R.layout.listclntpatimgupdt,result);
    ...
    public class ImageAdapter extends ArrayAdapter {
        ...
        private List<GetImages> img;
        private int resource;
        private LayoutInflater inflater;
        public ImageAdapter(Context context, int resource, List<GetImages> objects){
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(convertView == null){
                convertView = inflater.inflate(R.layout.listclntpatimgupdt,null);
            }
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (bitmap == null) {
                        ...
                        if(imb.equals(ii1))
                            new UploadImage12(UpdateClntCustImage.this).execute(imb, id, visit, v2);
                        if(imc.equals(ii2))
                            new UploadImage13(UpdateClntCustImage.this).execute(imc, id, visit, v2);
                        if(imd.equals(ii4))
                            new UploadImage14(UpdateClntCustImage.this).execute(imd, id, visit, v2);
            ...
            t1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (bitmap == null) {
                        ...
                        if(ima.equals(ii1))
                            new UploadImage21(UpdateClntCustImage.this).execute(ima,id,visit,v2);
                        if(imc.equals(ii2))
                            new UploadImage23(UpdateClntCustImage.this).execute(imc, id, visit, v2);
                        if(imd.equals(ii4))
                            new UploadImage24(UpdateClntCustImage.this).execute(imd,id,visit,v2);
            ...
            t2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (bitmap == null) {
                        ...
                        if(ima.equals(ii1))
                            new UploadImage31(UpdateClntCustImage.this).execute(ima,id,visit,v2);
                        if(imb.equals(ii2))
                            new UploadImage32(UpdateClntCustImage.this).execute(imb, id, visit, v2);
                        if(imd.equals(ii4))
                            new UploadImage34(UpdateClntCustImage.this).execute(imd,id,visit,v2);
            ...
            t3.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (bitmap == null) {
                        ...
                        if(ima.equals(ii1))
                            new UploadImage41(UpdateClntCustImage.this).execute(ima, id, visit, v2);
                        if(imb.equals(ii2))
                            new UploadImage42(UpdateClntCustImage.this).execute(imb, id, visit, v2);
                        if(imc.equals(ii3))
                            new UploadImage43(UpdateClntCustImage.this).execute(imc, id, visit, v2);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()){
            case R.id.logout:
                Intent intent = new Intent(UpdateClntCustImage.this, HomePage.class);
