...
public class PatientRegistration extends AppCompatActivity implements  ConnectivityReceiver.ConnectivityReceiverListener{
    boolean isConnected;
    ...
    String uid,name,age,ph,add,cc,diag,ta,td,amt,rcll,vst,dt,rmk;
...
//        });
        ...
        et8 = findViewById(R.id.custphone);
        et9 = findViewById(R.id.custvisit);
        et10 = findViewById(R.id.custadd);
        et11 = findViewById(R.id.custremarks);
...
//        tv2.setText(c.getTime().toString());
...
//                Log.e("getSelected", s);
                if(name.equals("")){
                    ...
                    if (isConnected) {
                        String type = "login";
                        getLogin.execute(type, uid, name, age, cc, diag, ta, td, amt, rcll, s, t, u, vv, w, x, y, z, a, b, cccc, d, vst, dt, ph, add,aid1,rmk);
                    } else {
                        checkConnection();
                        if (isConnected)
    ...
    public void onBackPressed() {
        Intent intent = new Intent(PatientRegistration.this, AdminDashboard.class);
    ...
    public class GetLogin extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String path = "http://ramjidental.com/RamjiApp/registerCust.php";
            ...
            if(result.equals("success")) {
                ...
                al.setButton(DialogInterface.BUTTON_NEUTRAL, "INSERT", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                       Intent intent = new Intent(PatientRegistration.this,PatientImageRegistration.class);
