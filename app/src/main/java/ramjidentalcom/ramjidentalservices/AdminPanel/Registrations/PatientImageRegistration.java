...
public class PatientImageRegistration extends AppCompatActivity implements  ConnectivityReceiver.ConnectivityReceiverListener{
    boolean isConnected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.patient_image_registration);
    ...
    private void uploadImage(){
        class UploadImage extends AsyncTask<String,Void,String> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(PatientImageRegistration.this, "Uploading...", null,true,true);
            ...
            protected void onPostExecute(String s) {
                ...
                if("success".equals(s)) {
                    ...
                    al.setButton(DialogInterface.BUTTON_NEGATIVE, "CANCEL", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int which) {
                            dialog.dismiss();
                            Intent intent = new Intent(PatientImageRegistration.this,AdminDashboard.class);
