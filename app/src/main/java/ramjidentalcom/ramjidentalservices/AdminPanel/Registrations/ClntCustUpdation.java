...
public class ClntCustUpdation extends AppCompatActivity implements  ConnectivityReceiver.ConnectivityReceiverListener{
    boolean isConnected;
    ...
    String vsit = "";
    Button bt1;
    String uid,client,name,age,cc,ph,add,diag,ta,td,amt,rcll,vst,date,rmk;
    String id="",clientid="";
    GetLogin getLogin = new GetLogin(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.clnt_cust_updation);
        ...
        et10 = findViewById(R.id.clntcustphone);
        et11 = findViewById(R.id.clntcustadd);
        et4 = findViewById(R.id.clntcustdiagnosis);
        et5 = findViewById(R.id.clntcustta);
        et6 = findViewById(R.id.clntcusttd);
        et7 = findViewById(R.id.clntcustamount);
        et8 = findViewById(R.id.clntcustrecall);
        et9 = findViewById(R.id.clntcustvisit);
        et12 = findViewById(R.id.clntcustremarks);
        ...
        String dateString = sdf.format(dte);
        tv2.setText(dateString);
        Intent intent = getIntent();
        id = intent.getStringExtra("id");
        clientid = intent.getStringExtra("clnt");
    ...
    protected void showData(){
        try {
            ...
            JSONArray firstArray = firstObject.getJSONArray("clientuid");
            String name = "",ag = "",ph = "",add = "",cc = "",dg = "",tad = "",td = "",amt = "",rcll = "",dq1 = "",dq2 = "",dq3 = "",dq4 = "",
            ...
            for (int i = 0; i < firstArray.length(); i++) {
                ...
                String clt = lastObject.getString("client");
    ...
    class FetchInBackground extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String json_url = "http://ramjidental.com/RamjiApp/fetchClntCustByUID.php";
            String result = null;
            try {
    ...
    public class GetLogin extends AsyncTask<String,Void,String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String path = "http://ramjidental.com/RamjiApp/updateClntCust.php";
        ...
        protected void onPostExecute(String result) {
            if(result.equals("success")) {
                al.setMessage("Patient Updated Successfully. Insert Images of Patient");
                al.setButton(DialogInterface.BUTTON_NEUTRAL, "INSERT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Intent intent = new Intent(ClntCustUpdation.this,UpdateClntCustImage.class);
                ...
                al.setButton(DialogInterface.BUTTON_NEGATIVE, "CANCEL", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.dismiss();
                        Intent intent = new Intent(ClntCustUpdation.this, AdminDashboard.class);
                        intent.putExtra("allid",aid);
                        intent.putExtra("oid",oid);
                        startActivity(intent);
                        finish();
